  ...
  loadLiquidFillGauge(elementId, value, config) {
    ...
    if(config.valueCountUp){
      var textTween = function(){
        ...
        let self = this;
        return function(t) { self.textContent = textRounder(i(t)) + percentText; }
    };
      text1.transition()
    ...
    function GaugeUpdater(){
      this.update = function(value){
        ...
        var textTween = function(){
            ...
            let self = this;
            return function(t) { self.textContent = textRounderUpdater(i(t)) + percentText; }
        };
	...
	updateData(){
      ...
      if (data.value === null || data.value === undefined) {
        d3.select('#waterbll-container')
        .style('display','none');
      }
      else {
        var v = +data.value;
        d3.select('#card2police')
        .style('display','block');
	...
	render(){
      let {idDom} = this.props && this.props.config;
      return(
        <div className="app-circleBall">
          <div id={idDom}></div>
        </div>
      );
	}
